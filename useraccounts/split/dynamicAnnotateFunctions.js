var getTwoNodesSpecificTopic = function(session_db,annotateTopicName) {
  return session_db.run('MATCH (node1:Opinion {topic: \"'+annotateTopicName+'\"}) OPTIONAL MATCH (node1)-[r]-(node2:Opinion) WITH node1, count(r) as rels RETURN node1 ORDER BY rels ASC LIMIT 2');
}
