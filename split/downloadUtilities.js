//database query to return all the necessary information required for the JSON download for all topics
...
//database query to return all the necessary information required for the JSON download for topicName
...
//formats the data returned by downloadQuery into the format in the JSON
...
//returns the modal relationship between two nodes, along with the proportion, and the number of each type of relationship
